...
-- ── active_attempts: track credit deduction at test start (prevents double deduction) ──
...
-- Auto-clean tokens older than 48 hours (run periodically or via cron)
-- DELETE FROM active_attempts WHERE created_at < NOW() - INTERVAL '48 hours';
